#ifndef STRANSPOSE_20413_352X4X48X28X28_PAR_H
#define STRANSPOSE_20413_352X4X48X28X28_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
void sTranspose_20413_352x4x48x28x28_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   int lda3;
