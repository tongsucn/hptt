#ifndef STRANSPOSE_210_384X355X384_PAR_H
#define STRANSPOSE_210_384X355X384_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
void sTranspose_210_384x355x384_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   if( lda == NULL ){
