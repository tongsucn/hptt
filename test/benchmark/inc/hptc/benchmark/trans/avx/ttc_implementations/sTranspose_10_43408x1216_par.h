#ifndef STRANSPOSE_10_43408X1216_PAR_H
#define STRANSPOSE_10_43408X1216_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
#endif
#ifndef _TTC_STRANSPOSE32X32
#define _TTC_STRANSPOSE32X32
//B_ji = alpha * A_ij + beta * B_ji
static INLINE void sTranspose32x32(const float* __restrict__ A, const int lda, float* __restrict__ B, const int ldb  ,const __m256 &reg_alpha ,const __m256 &reg_beta)
{
...
#endif
#ifndef _TTC_STRANSPOSE32X32_PREFETCH_5
#define _TTC_STRANSPOSE32X32_PREFETCH_5
//B_ji = alpha * A_ij + beta * B_ji
static INLINE void sTranspose32x32_prefetch_5(const float* __restrict__ A, const int lda, float* __restrict__ B, const int ldb, const float* __restrict__ Anext0, float* __restrict__ Bnext0, const float* __restrict__ Anext1, float* __restrict__ Bnext1  ,const __m256 &reg_alpha ,const __m256 &reg_beta)
{
   //invoke micro-transpose
   sTranspose8x8(A, lda, B, ldb  , reg_alpha , reg_beta);

   //prefetch B
   _mm_prefetch((char*)(Bnext0 + 16 + 8 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 9 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 10 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 11 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 12 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 13 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 14 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 15 * ldb), _MM_HINT_T2);
   //invoke micro-transpose
   sTranspose8x8(A + 8 * lda, lda, B + 8, ldb  , reg_alpha , reg_beta);
   ...
   //prefetch A
   _mm_prefetch((char*)(Anext0 + 16 + 0 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 1 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 2 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 3 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 4 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 5 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 6 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 7 * lda), _MM_HINT_T2);
   //prefetch B
   _mm_prefetch((char*)(Bnext0 + 16 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 17 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 18 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 19 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 20 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 21 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 22 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 23 * ldb), _MM_HINT_T2);
   //invoke micro-transpose
   sTranspose8x8(A + 24 * lda, lda, B + 24, ldb  , reg_alpha , reg_beta);
   ...
   //prefetch A
   _mm_prefetch((char*)(Anext0 + 16 + 16 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 17 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 18 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 19 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 20 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 21 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 22 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 23 * lda), _MM_HINT_T2);
   //prefetch B
   _mm_prefetch((char*)(Bnext0 + 16 + 16 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 17 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 18 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 19 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 20 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 21 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 22 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 23 * ldb), _MM_HINT_T2);
   //invoke micro-transpose
   sTranspose8x8(A + 8 + 8 * lda, lda, B + 8 + 8 * ldb, ldb  , reg_alpha , reg_beta);

   //prefetch A
   _mm_prefetch((char*)(Anext0 + 16 + 24 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 25 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 26 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 27 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 28 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 29 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 30 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext0 + 16 + 31 * lda), _MM_HINT_T2);
   //invoke micro-transpose
   sTranspose8x8(A + 8 + 16 * lda, lda, B + 16 + 8 * ldb, ldb  , reg_alpha , reg_beta);
   ...
   //prefetch B
   _mm_prefetch((char*)(Bnext0 + 16 + 24 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 25 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 26 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 27 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 28 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 29 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 30 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext0 + 16 + 31 * ldb), _MM_HINT_T2);
   //invoke micro-transpose
   sTranspose8x8(A + 16 + 8 * lda, lda, B + 8 + 16 * ldb, ldb  , reg_alpha , reg_beta);
   ...
   //prefetch A
   _mm_prefetch((char*)(Anext1 + 16 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 17 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 18 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 19 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 20 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 21 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 22 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 23 * lda), _MM_HINT_T2);
   //prefetch B
   _mm_prefetch((char*)(Bnext1 + 16 + 0 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext1 + 16 + 1 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext1 + 16 + 2 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext1 + 16 + 3 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext1 + 16 + 4 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext1 + 16 + 5 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext1 + 16 + 6 * ldb), _MM_HINT_T2);
   _mm_prefetch((char*)(Bnext1 + 16 + 7 * ldb), _MM_HINT_T2);
   //invoke micro-transpose
   sTranspose8x8(A + 24 + 8 * lda, lda, B + 8 + 24 * ldb, ldb  , reg_alpha , reg_beta);

   //prefetch A
   _mm_prefetch((char*)(Anext1 + 24 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 25 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 26 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 27 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 28 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 29 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 30 * lda), _MM_HINT_T2);
   _mm_prefetch((char*)(Anext1 + 31 * lda), _MM_HINT_T2);
   //invoke micro-transpose
   sTranspose8x8(A + 24 + 16 * lda, lda, B + 16 + 24 * ldb, ldb  , reg_alpha , reg_beta);
...
#endif
/**
 * B(i1,i0) <- alpha * A(i0,i1) + beta * B(i1,i0);
 */
template<int size0, int size1>
void sTranspose_10_43408x1216_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   if( lda == NULL ){
      lda1 = size0;
...
#pragma omp for collapse(2) schedule(static)
      for(int i0 = 0; i0 < size0 - 31; i0+= 32)
         ...
         {
            int offsetA = i0 + i1*lda1;
            int offsetB = i0*ldb1 + i1;
            if( counter >= 1 ){
               ...
               sTranspose32x32_prefetch_5(&A[currentTask.offsetA], lda1, &B[currentTask.offsetB], ldb1, &A[offsetAnext0], &B[offsetBnext0], &A[offsetA], &B[offsetB]  ,reg_alpha ,reg_beta);
               tasks.pop();
            }
            counter++;
      ...
      while(tasks.size() > 0){
          ...
          sTranspose32x32(&A[task.offsetA], lda1, &B[task.offsetB], ldb1   ,reg_alpha ,reg_beta);
          tasks.pop();
      }
      //Remainder loop
#pragma omp for collapse(1) schedule(static)
      for(int i0 = size0 - remainder0; i0 < size0; i0 += 1)
         for(int i1 = 0; i1 < size1 - remainder1; i1 += 1)
            B[i0*ldb1 + i1] = alpha*A[i0 + i1*lda1] + beta*B[i0*ldb1 + i1];
      //Remainder loop
#pragma omp for collapse(1) schedule(static)
