#ifndef STRANSPOSE_1032_96X608X12X75_PAR_H
#define STRANSPOSE_1032_96X608X12X75_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
/**
...
void sTranspose_1032_96x608x12x75_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   int lda3;
