#ifndef STRANSPOSE_204153_32X15X32X15X15X15_PAR_H
#define STRANSPOSE_204153_32X15X32X15X15X15_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
void sTranspose_204153_32x15x32x15x15x15_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   int lda3;
