#ifndef STRANSPOSE_543210_112X5X15X15X15X32_PAR_H
#define STRANSPOSE_543210_112X5X15X15X15X32_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
#endif
#ifndef _TTC_STRANSPOSE16X32
#define _TTC_STRANSPOSE16X32
//B_ji = alpha * A_ij + beta * B_ji
static INLINE void sTranspose16x32(const float* __restrict__ A, const int lda, float* __restrict__ B, const int ldb  ,const __m256 &reg_alpha ,const __m256 &reg_beta)
{
...
#endif
#ifndef _TTC_STRANSPOSE16X32_PREFETCH_5
#define _TTC_STRANSPOSE16X32_PREFETCH_5
//B_ji = alpha * A_ij + beta * B_ji
static INLINE void sTranspose16x32_prefetch_5(const float* __restrict__ A, const int lda, float* __restrict__ B, const int ldb, const float* __restrict__ Anext0, float* __restrict__ Bnext0, const float* __restrict__ Anext1, float* __restrict__ Bnext1  ,const __m256 &reg_alpha ,const __m256 &reg_beta)
{
   //invoke micro-transpose
   sTranspose8x8(A, lda, B, ldb  , reg_alpha , reg_beta);
...
#endif
/**
 * B(i5,i4,i3,i2,i1,i0) <- alpha * A(i0,i1,i2,i3,i4,i5) + beta * B(i5,i4,i3,i2,i1,i0);
 */
template<int size0, int size1, int size2, int size3, int size4, int size5>
void sTranspose_543210_112x5x15x15x15x32_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   int lda3;
...
#pragma omp for collapse(6) schedule(static)
      for(int i0 = 0; i0 < size0 - 15; i0+= 16)
         for(int i1 = 0; i1 < size1; i1+= 1)
            for(int i2 = 0; i2 < size2; i2+= 1)
               for(int i5 = 0; i5 < size5 - 31; i5+= 32)
                  for(int i3 = 0; i3 < size3; i3+= 1)
                     for(int i4 = 0; i4 < size4; i4+= 1)
                     {
                        int offsetA = i0 + i1*lda1 + i2*lda2 + i3*lda3 + i4*lda4 + i5*lda5;
                        int offsetB = i0*ldb5 + i1*ldb4 + i2*ldb3 + i3*ldb2 + i4*ldb1 + i5;
                        if( counter >= 1 ){
                           ...
                           sTranspose16x32_prefetch_5(&A[currentTask.offsetA], lda5, &B[currentTask.offsetB], ldb5, &A[offsetAnext0], &B[offsetBnext0], &A[offsetA], &B[offsetB]  ,reg_alpha ,reg_beta);
                           tasks.pop();
                        }
                        counter++;
      ...
      while(tasks.size() > 0){
          ...
          sTranspose16x32(&A[task.offsetA], lda5, &B[task.offsetB], ldb5   ,reg_alpha ,reg_beta);
          tasks.pop();
      }
      //Remainder loop
#pragma omp for collapse(5) schedule(static)
      for(int i0 = size0 - remainder0; i0 < size0; i0 += 1)
         for(int i1 = 0; i1 < size1; i1 += 1)
            for(int i2 = 0; i2 < size2; i2 += 1)
               for(int i5 = 0; i5 < size5 - remainder5; i5 += 1)
                  for(int i3 = 0; i3 < size3; i3 += 1)
                     for(int i4 = 0; i4 < size4; i4 += 1)
                        B[i0*ldb5 + i1*ldb4 + i2*ldb3 + i3*ldb2 + i4*ldb1 + i5] = alpha*A[i0 + i1*lda1 + i2*lda2 + i3*lda3 + i4*lda4 + i5*lda5] + beta*B[i0*ldb5 + i1*ldb4 + i2*ldb3 + i3*ldb2 + i4*ldb1 + i5];
      //Remainder loop
#pragma omp for collapse(5) schedule(static)
      for(int i0 = 0; i0 < size0; i0 += 1)
         for(int i1 = 0; i1 < size1; i1 += 1)
            for(int i2 = 0; i2 < size2; i2 += 1)
               for(int i5 = size5 - remainder5; i5 < size5; i5 += 1)
                  for(int i3 = 0; i3 < size3; i3 += 1)
                     for(int i4 = 0; i4 < size4; i4 += 1)
                        B[i0*ldb5 + i1*ldb4 + i2*ldb3 + i3*ldb2 + i4*ldb1 + i5] = alpha*A[i0 + i1*lda1 + i2*lda2 + i3*lda3 + i4*lda4 + i5*lda5] + beta*B[i0*ldb5 + i1*ldb4 + i2*ldb3 + i3*ldb2 + i4*ldb1 + i5];
   }
