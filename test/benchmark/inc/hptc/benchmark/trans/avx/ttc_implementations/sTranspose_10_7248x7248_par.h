#ifndef STRANSPOSE_10_7248X7248_PAR_H
#define STRANSPOSE_10_7248X7248_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
void sTranspose_10_7248x7248_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   if( lda == NULL ){
      lda1 = size0;
