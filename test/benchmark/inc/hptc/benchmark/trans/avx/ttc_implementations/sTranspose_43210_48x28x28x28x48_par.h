#ifndef STRANSPOSE_43210_48X28X28X28X48_PAR_H
#define STRANSPOSE_43210_48X28X28X28X48_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
void sTranspose_43210_48x28x28x28x48_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   int lda3;
