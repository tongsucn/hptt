#ifndef STRANSPOSE_325104_112X5X15X32X15X15_PAR_H
#define STRANSPOSE_325104_112X5X15X32X15X15_PAR_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
#endif
/**
 * B(i3,i2,i5,i1,i0,i4) <- alpha * A(i0,i1,i2,i3,i4,i5) + beta * B(i3,i2,i5,i1,i0,i4);
 */
template<int size0, int size1, int size2, int size3, int size4, int size5>
void sTranspose_325104_112x5x15x32x15x15_par( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   int lda3;
...
#pragma omp for collapse(6) schedule(static)
      for(int i4 = 0; i4 < size4; i4+= 1)
         for(int i0 = 0; i0 < size0 - 15; i0+= 16)
            for(int i3 = 0; i3 < size3 - 31; i3+= 32)
               for(int i1 = 0; i1 < size1; i1+= 1)
                  for(int i5 = 0; i5 < size5; i5+= 1)
                     for(int i2 = 0; i2 < size2; i2+= 1)
                     {
                        ...
                        int offsetB = i0*ldb4 + i1*ldb3 + i2*ldb1 + i3 + i4*ldb5 + i5*ldb2;
                        if( counter >= 1 ){
                           ...
                           sTranspose16x32_prefetch_5(&A[currentTask.offsetA], lda3, &B[currentTask.offsetB], ldb4, &A[offsetAnext0], &B[offsetBnext0], &A[offsetA], &B[offsetB]  ,reg_alpha ,reg_beta);
                           tasks.pop();
                        }
                        counter++;
      ...
      while(tasks.size() > 0){
          ...
          sTranspose16x32(&A[task.offsetA], lda3, &B[task.offsetB], ldb4   ,reg_alpha ,reg_beta);
          tasks.pop();
      }
      //Remainder loop
         ...
         for(int i0 = size0 - remainder0; i0 < size0; i0 += 1)
            for(int i3 = 0; i3 < size3 - remainder3; i3 += 1)
               for(int i1 = 0; i1 < size1; i1 += 1)
                  for(int i5 = 0; i5 < size5; i5 += 1)
                     for(int i2 = 0; i2 < size2; i2 += 1)
                        B[i0*ldb4 + i1*ldb3 + i2*ldb1 + i3 + i4*ldb5 + i5*ldb2] = alpha*A[i0 + i1*lda1 + i2*lda2 + i3*lda3 + i4*lda4 + i5*lda5] + beta*B[i0*ldb4 + i1*ldb3 + i2*ldb1 + i3 + i4*ldb5 + i5*ldb2];
      //Remainder loop
#pragma omp for collapse(5) schedule(static)
      for(int i4 = 0; i4 < size4; i4 += 1)
