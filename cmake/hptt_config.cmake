...
macro(hptt_set_compiler)
  ...
  if (${CMAKE_CXX_COMPILER_ID} STREQUAL "Intel")
    string(CONCAT HPTT_CXX_FLAG ${HPTT_CXX_FLAG} " -qopenmp")
    string(CONCAT HPTT_DEBUG_FLAG ${HPTT_DEBUG_FLAG} " -debug full")
  elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL "GNU")
    string(CONCAT HPTT_CXX_FLAG ${HPTT_CXX_FLAG}
      " -fopenmp -fsanitize=address")
    string(CONCAT HPTT_DEBUG_FLAG ${HPTT_DEBUG_FLAG}
  ...
  if (${HPTT_BUILD_DEBUG})
    ...
    string(CONCAT HPTT_CXX_FLAG ${HPTT_CXX_FLAG} " " ${HPTT_DEBUG_FLAG})
  else ()
    # Use release configuration.
    string(CONCAT HPTT_CXX_FLAG ${HPTT_CXX_FLAG} " " ${HPTT_RELEASE_FLAG})
  endif ()
  string(CONCAT CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} " " ${HPTT_CXX_FLAG})
