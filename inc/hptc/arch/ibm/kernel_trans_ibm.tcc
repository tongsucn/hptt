#pragma once
#ifndef HPTC_ARCH_IBM_KERNEL_TRANS_IBM_TCC_
#define HPTC_ARCH_IBM_KERNEL_TRANS_IBM_TCC_
...
struct IntrinImpl<FloatType, TYPE,
  ...
  static HPTC_INL Reg<FloatType, TYPE> set_reg(const Deduced coef) {
    return coef;
  }
};
...
struct IntrinImpl<FloatType, TYPE,
  ...
  static HPTC_INL Reg madd(const Reg &reg_out, const Reg &reg_coef,
      const Reg &reg_in) {
...
#endif // HPTC_ARCH_IBM_KERNEL_TRANS_IBM_TCC_
