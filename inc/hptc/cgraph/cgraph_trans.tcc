...
template <typename ParamType>
HPTC_INL void CGraphTrans<ParamType>::set_thread_ids(
...
template <typename ParamType>
HPTC_INL void CGraphTrans<ParamType>::unset_thread_ids() {
...
template <typename ParamType>
HPTC_INL void CGraphTrans<ParamType>::exec_general_(const TensorUInt th_idx) {
