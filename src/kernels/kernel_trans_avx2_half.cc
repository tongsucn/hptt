...
RegType<float> KernelTransAvx2<float, USAGE, KernelTypeTrans::KERNEL_HALF>::
reg_coef(const DeducedFloatType<float> coef) {
  return _mm_set1_ps(coef);
}

template <CoefUsageTrans USAGE>
void KernelTransAvx2<float, USAGE, KernelTypeTrans::KERNEL_HALF>::
...
template <CoefUsageTrans USAGE>
RegType<double> KernelTransAvx2<double, USAGE, KernelTypeTrans::KERNEL_HALF>::
reg_coef(const DeducedFloatType<double> coef) {
  return _mm_set1_pd(coef);
}

template <CoefUsageTrans USAGE>
void KernelTransAvx2<double, USAGE, KernelTypeTrans::KERNEL_HALF>::
...
KernelTransAvx2<FloatComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::
reg_coef(const DeducedFloatType<FloatComplex> coef) {
  return _mm_set1_ps(coef);
}

template <CoefUsageTrans USAGE>
void KernelTransAvx2<FloatComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::
...
KernelTransAvx2<DoubleComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::
reg_coef(const DeducedFloatType<DoubleComplex> coef) {
  return coef;
}

template <CoefUsageTrans USAGE>
void KernelTransAvx2<DoubleComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::
