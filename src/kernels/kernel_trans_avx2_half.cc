...
/*
 * Implementation for class KernelTransAvx2
 */
template <CoefUsageTrans USAGE>
INLINE RegType<float>
KernelTransAvx2<float, USAGE, KernelTypeTrans::KERNEL_HALF>::reg_coef(
    const DeducedFloatType<float> coef) {
  return _mm_set1_ps(coef);
}

template <CoefUsageTrans USAGE>
INLINE void KernelTransAvx2<float, USAGE, KernelTypeTrans::KERNEL_HALF>::exec(
...
KernelTransAvx2<double, USAGE, KernelTypeTrans::KERNEL_HALF>::reg_coef(
    const DeducedFloatType<double> coef) {
  return _mm_set1_pd(coef);
}

template <CoefUsageTrans USAGE>
INLINE void KernelTransAvx2<double, USAGE, KernelTypeTrans::KERNEL_HALF>::exec(
...
KernelTransAvx2<FloatComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::reg_coef(
...
template <CoefUsageTrans USAGE>
INLINE void
KernelTransAvx2<FloatComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::exec(
...
KernelTransAvx2<DoubleComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::reg_coef(
...
template <CoefUsageTrans USAGE>
INLINE void
KernelTransAvx2<DoubleComplex, USAGE, KernelTypeTrans::KERNEL_HALF>::exec(
...
/*
 * Explicit instantiation for struct KernelTransAvx2
 */
template struct KernelTransAvx2<float, CoefUsageTrans::USE_NONE,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<float, CoefUsageTrans::USE_ALPHA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<float, CoefUsageTrans::USE_BETA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<float, CoefUsageTrans::USE_BOTH,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<double, CoefUsageTrans::USE_NONE,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<double, CoefUsageTrans::USE_ALPHA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<double, CoefUsageTrans::USE_BETA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<double, CoefUsageTrans::USE_BOTH,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<FloatComplex, CoefUsageTrans::USE_NONE,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<FloatComplex, CoefUsageTrans::USE_ALPHA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<FloatComplex, CoefUsageTrans::USE_BETA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<FloatComplex, CoefUsageTrans::USE_BOTH,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<DoubleComplex, CoefUsageTrans::USE_NONE,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<DoubleComplex, CoefUsageTrans::USE_ALPHA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<DoubleComplex, CoefUsageTrans::USE_BETA,
         KernelTypeTrans::KERNEL_HALF>;
template struct KernelTransAvx2<DoubleComplex, CoefUsageTrans::USE_BOTH,
         KernelTypeTrans::KERNEL_HALF>;
